describe('Blood Of Onnotangu', function() {
    integration(function() {
        describe('Blood Of Onnotangu\'s ability', function() {
            beforeEach(function() {
                this.setupTest({
                    phase: 'conflict',
                    player1: {
                        ...
                        dynastyDeck: ['shiba-tsukune', 'mantis-tenkinja'],
                        hand: ['charge', 'fine-katana', 'banzai', 'watch-commander']
                    },
                    player2: {
                        fate:2,
                        inPlay: ['miya-mystic'],
                        hand: ['fine-katana','watch-commander'],
                        provinces: ['blood-of-onnotangu']
                    }
                });
                this.tsukune = this.player1.placeCardInProvince('shiba-tsukune', 'province 1');
                this.mantis = this.player1.placeCardInProvince('mantis-tenkinja', 'province 2');
            ...
            it('should prevent either play from playing cards with a fate cost', function() {
                this.player2.clickCard('watch-commander', 'hand');
                expect(this.player2).toHavePrompt('Conflict Action Window');
                this.player2.pass();
                this.player1.clickCard('watch-commander', 'hand');
